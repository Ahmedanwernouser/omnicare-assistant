...
Probes /ready rather than /health on purpose. Compose gates the frontend on
this, and "the process is up" is not the same as "the policy index is loaded".
"""
...
URL = os.getenv("HEALTHCHECK_URL", "http://127.0.0.1:8000/api/v1/ready")
